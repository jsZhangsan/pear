	...
	// Pass this if window is not defined yet
		...
		(
				...
				function(window, noGlobal) {
					...
					// Prevent auto-execution of scripts when no explicit
					...
					// collapse sibling forms: the second one becomes a child of
					// the first one.
					// Because of that, this security measure has to be disabled
					// in Safari 8.
					...
					jQuery.parseHTML = function(data, context, keepScripts) {
						...
						// document.implementation stops scripts or inline event
						// handlers from
						// being executed immediately
						context = context
								|| (support.createHTMLDocument ? document.implementation
										.createHTMLDocument("")
										: document);
